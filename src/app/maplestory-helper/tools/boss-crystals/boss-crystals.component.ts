...
export class BossCrystalsComponent implements OnInit {
  bosses = [
    ...
    {name: 'First Adversary (Easy)', meso: 985000000, shared: ['First Adversary (Normal)', 'First Adversary (Hard)', 'First Adversary (Extreme)'], url: 'Adversary'},
    {name: 'First Adversary (Normal)', meso: 1365000000, shared: ['First Adversary (Easy)', 'First Adversary (Hard)', 'First Adversary (Extreme)'], url: 'Adversary'},
    {name: 'First Adversary (Hard)', meso: 2940000000, shared: ['First Adversary (Easy)', 'First Adversary (Normal)', 'First Adversary (Extreme)'], url: 'Adversary'},
    {name: 'First Adversary (Extreme)', meso: 5880000000, shared: ['First Adversary (Easy)', 'First Adversary (Normal)', 'First Adversary (Hard)'], url: 'Adversary'},
